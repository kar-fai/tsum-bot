...
objects["iPad5,3"] = function ()
    win_button_close = {
        newTsumObject("win_button_close", 767, 1579, 16231944), -- higher
        newTsumObject("win_button_close", 767, 1899, 16230920)  -- lower
    };
    ...
    win_button_ok = newTsumObject("win_button_ok", 1055, 1186, 15707664); -- combine 5 cases
     win_button_receipt = newTsumObject("win_button_receipt", 594, 281, 10846794);
